...
when introduced the offset, also tightened the obs errors, talk about how this affected the tighter parameter posteriors. the offset posterior distribution spanned over 0, meaning that maybe there was no need for it?
