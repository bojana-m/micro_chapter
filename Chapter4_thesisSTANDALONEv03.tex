...
Parameter trace-plots showed $kLA_{O_2}^{air}$, $K_m$, $\sigma_{rP}$, $\sigma_{rR}$ and $R_R$ did not mix well, some autocorrelation between samples was present (Figure \ref{fig:micro_exp_parameters_model2}). 
