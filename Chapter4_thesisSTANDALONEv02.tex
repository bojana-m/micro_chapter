...
\subsubsection{Carbon chemistry iterative solution}
...
Choice of dissociation constants $K_1$ and $K_2$ were Mehrbach (refit BY DICKSON AND MILLERO) with 1.23$K_1$ and 0.53$K_2$ measured experiment specific adjustments:
\begin{align}
...
H_{n+1} 		&= 10^{-pH_{n+1}}  \\
CO2_{n+1}  		&= \frac{H_{n+1}^2 DIC}{H_{n+1}^2 + K_1 H_{n+1} + K_1 K_2}  \\
HCO3_{n+1} 		&= \frac{H_{n+1} K_1 DIC}{H_{n+1}^2 + K_1 H_{n+1} + K_1 K_2}  \\
CO3_{n+1}  		&= \frac{K_1 K_2 DIC}{H_{n+1}^2 + K_1 H_{n+1} + K_1 K_2}\label{newton_raph_iterations_end} 
\end{align}
